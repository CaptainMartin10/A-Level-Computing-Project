    ...
    public class Province
    {
        ...
        public bool ContainsMousePointer(Point mousePoint)
        {
            if (X % 2 == 0)
            {
                ...
                Rectangle HexBounds7 = new Rectangle((X * 27) + 3, (Y * 36) + 1, 30, 14);
                Rectangle HexBounds8 = new Rectangle((X * 27) + 2, (Y * 36) + 3, 32, 10);
                Rectangle HexBounds9 = new Rectangle((X * 27) + 1, (Y * 36) + 5, 34, 6);
                Rectangle HexBounds10 = new Rectangle((X * 27), (Y * 36) + 7, 36, 2);
